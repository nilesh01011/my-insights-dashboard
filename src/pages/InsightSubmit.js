        ...
        <div className='w-full h-full'>
            ...
            <div className='w-full p-[19px_16px] pb-[6rem] max-w-[1260px] mx-auto '>
                ...
                <div className='w-full h-full bg-white rounded-[10px]'>
                    ...
                    {
                        collapseOne === true &&
                        <div className='px-[16px] mt-[12px] flex flex-col gap-[16px]'>
                            {/* Interaction Title */}
                ...
                {/* Insight Statement */}
                <div className='bg-white rounded-[10px] flex flex-col gap-[15px] mt-[20px]'>
                    <div className='w-full h-full'>
                        {/* header */}
                        <div className={`w-full p-[16px] pb-0 cursor-pointer flex items-center justify-between`}>
                            {/* title */}
                            <h2 className='font-bold mb-[6.5px]'>Insight Statement</h2>
                        </div>

                        {/* Mode of Interaction */}
                        <div className='flex w-fill flex-col gap-[5px] px-[16px]'>
                            {/* title */}
                    ...
                    <div className='w-full h-full'>
                        {/* header */}
                        <div className={`w-full px-[16px] cursor-pointer flex items-center justify-between`}>
                            {/* title */}
                            <h2 className='font-bold mb-[6.5px]'>Observation 1</h2>
                        </div>

                        {/* Mode of Interaction */}
                        <div className='flex w-fill flex-col gap-[5px] px-[16px] pt-0'>
                            {/* title */}
                            {/* <h6>Please write down statement</h6> */}
                            {/* input fields */}
                            <textarea placeholder='Type here...' disabled className='focus:outline-none border-[1px] border-[#DEDEDE] bg-[#F4F4F4] cursor-not-allowed p-[10px] resize-none rounded-[5px]' maxLength={300}></textarea>
                    ...
                    <div className='w-full h-full'>
                        ...
                        <div className={`w-full px-[16px] cursor-pointer flex items-center justify-between`}>
                            {/* title */}
                            <h2 className='font-bold mb-[6.5px]'>Observation 2</h2>
                        </div>
                    ...
                    <div className='w-full h-full'>
                        {/* header */}
                        <div onClick={() => setCollapseTwo(!collapseTwo)} className={`${collapseTwo === true && 'pb-0'} w-full px-[16px] cursor-pointer flex items-center justify-between`}>
                            {/* title */}
                            <h2 className='font-bold mb-[15px]'>Additional Details</h2>
                            {/* arrow icons */}
                        ...
                        {
                            collapseTwo === true &&
                            <div className='flex flex-col gap-[16px] bg-white divide-y-[1px] divide-[#DEDEDE] p-[16px] pt-0 rounded-[10px]'>
                                {/* Additional Details */}
                                <div className='w-full h-full'>
                                    {/* Supporting Proof */}
                                    <div className='flex w-fill flex-col gap-[5px]'>
                                        ...
                                        {/* input fields */}
                                        <form className='w-full flex items-center relative justify-center p-[14px] rounded-[10px] border-[1px] border-dashed border-[#707070] cursor-pointer'>
                ...
                <div className='bg-white rounded-[10px] flex flex-col gap-[15px] mt-[20px]'>
                    <div className='w-full h-full'>
                        ...
                        <div className={`w-full p-[16px] pb-0 cursor-pointer flex items-center justify-between`}>
                            {/* title */}
                            <h2 className='font-bold mb-[6.5px]'>Insight Statement 2</h2>
                        </div>
