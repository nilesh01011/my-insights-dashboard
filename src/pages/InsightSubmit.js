        ...
        <div className='w-full h-full'>
            ...
            <div className='w-full p-[19px_16px] pb-[6rem] max-w-[1260px] mx-auto '>
                ...
                <div className='w-full h-full bg-white rounded-[10px]'>
                    ...
                    {
                        collapseOne === true &&
                        <div className='px-[16px] mt-[10px] flex flex-col gap-[16px]'>
                            {/* Interaction Title */}
                            ...
                            {/* Location */}
                            <div className='flex w-fill flex-col gap-[5px] mb-[15px]'>
                                {/* title */}
                                <h6>Location</h6>
                ...
                <div className='bg-white rounded-[10px] flex flex-col gap-[15px] mt-[20px]'>
                    <div className='w-full h-full'>
                        {/* header */}
                        <div className={`w-full p-[16px] pb-0 flex items-center justify-between`}>
                            {/* title */}
                    ...
                    <div className='w-full h-full'>
                        ...
                        <div className={`w-full px-[16px] flex items-center justify-between`}>
                            {/* title */}
                            <h2 className='font-[400] mb-[6.5px]'>Supporting observation 1</h2>
                        </div>
                    ...
                    <div className='w-full h-full'>
                        ...
                        <div className={`w-full px-[16px] flex items-center justify-between`}>
                            {/* title */}
                            <h2 className='font-[400] mb-[6.5px]'>Supporting observation 2</h2>
                        </div>
                    ...
                    <div className='w-full h-full'>
                        ...
                        <div className={`w-full px-[16px] flex items-center justify-between`}>
                            {/* title */}
                            <h2 className='font-[400] mb-[15px]'>Tag Business Function</h2>
                        </div>
                        ...
                        <div className='flex flex-col gap-[16px] bg-white divide-y-[1px] divide-[#DEDEDE] p-[16px] pt-0 rounded-[10px]'>
                            ...
                            <div className='w-full h-full'>
                                ...
                                <div className='flex w-fill flex-col gap-[5px]'>
                                    ...
                                    {/* input fields */}
                                    <form className='w-full flex items-center relative justify-center p-[14px] rounded-[10px] border-[1px] border-dashed border-[#707070] cursor-not-allowed'>
                ...
                <div className='bg-white rounded-[10px] flex flex-col gap-[15px] mt-[20px]'>
                    ...
                    <div className='w-full h-full'>
                        ...
                        <div className={` w-full px-[16px] flex items-center justify-between`}>
                            {/* title */}
                            <h2 className='font-[400] mb-[15px]'>Supporting Document</h2>
                        </div>
                        ...
                        <div className='flex flex-col gap-[16px] bg-white divide-y-[1px] divide-[#DEDEDE] p-[16px] pt-0 rounded-[10px]'>
                            ...
                            <div>
                                {/* title */}
                                <h6 className='my-[12px]'>Supporting Document<span className='text-[#FF3E5B]'>*</span></h6>
