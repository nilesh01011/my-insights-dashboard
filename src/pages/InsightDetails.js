                ...
                <div className='w-full h-full bg-white p-[16px] rounded-[10px]'>
                    ...
                    <div className='w-full h-full rounded-[10px]'>
                        ...
                        <div className={`w-full cursor-pointer flex items-center justify-between`}>
                            {/* title */}
                            <h2 className='font-bold mb-[6.5px]'>Supporting Observation 1<span className='text-red-500'>*</span></h2>
                        </div>
                                ...
                                rows.map((ele, index) => {
                                    return (
                                        <div key={index} className='w-full h-full bg-white rounded-[10px]'>
                                            ...
                                            <div className={`w-full cursor-pointer flex items-center justify-between`}>
                                                {/* title */}
                                                <h2 className='font-bold mb-[6.5px]'>Supporting Observation {index + 2}</h2>
                                                {/* delete icons */}
                    ...
                    <div className='w-full h-full flex flex-col gap-[20px]'>
                        {
                            rows_2?.map((ele, index) => {
                                return (
                                    <div key={index} className='w-full h-full mt-[20px] bg-white p-[16px] rounded-[10px]'>
                                        {/* Additional Details */}
                                        <div className='w-full h-full mb-[20px]'>
                                            {/* header */}
                                            <div className={`w-full flex items-center justify-between`}>
                                                    ...
                                                    rows.map((ele, index) => {
                                                        return (
                                                            <div key={ele.id} className='w-full h-full'>
                                                                ...
                                                                <div className={`w-full cursor-pointer flex items-center justify-between`}>
                                                                    {/* title */}
                                                                    <h2 className='font-bold'>Supporting Observation {index + 2}</h2>
                                                                </div>
