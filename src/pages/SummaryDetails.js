    ...
    return (
        <div className='w-full h-full'>
            ...
            <div className='w-full p-[19px_16px] max-w-[1260px] mx-auto'>
                ...
                {/* insights 1 */}
                <div className='w-full h-full bg-white rounded-[10px] flex flex-col gap-[15px] p-[16px] mt-[20px]'>
                    {/* Insight Statement */}
                    <div className='w-full h-full'>
                        {/* header */}
                        ...
                        <div className='flex flex-col gap-[16px]'>
                            ...
                            <div className='w-full h-full'>
                                ...
                                <div className='flex w-fill flex-col gap-[5px]'>
                                    ...
                                    <p className='w-full flex items-center justify-between my-[12px] cursor-pointer'>
                            ...
                            <div>
                                {/* title */}
                                <h6 className='mb-[12px]'>Tag Business Function<span className='text-[#FF3E5B]'>*</span></h6>
